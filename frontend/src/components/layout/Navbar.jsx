...
const Navbar = () => {
  ...
  const handleDownloadReport = () => {
    axios({
      url: 'http://localhost:4000/api/v1/reports/generate-users', // Backend endpoint
      method: 'GET',
      ...
      .then((response) => {
        ...
        link.download = 'User_Report.pdf';  // Name of the file being downloaded
        link.click();
      })
      .catch((error) => {
      ...
      <nav>
        ...
        <div className={show ? "links show" : "links"}>
          <ul>
            ...
            <li>
              <Link to={"/reports"} onClick={handleNavbar}>
                REPORTS
              </Link>
            </li>
          </ul>
